...
# executado diretamente (ex: `python clients/client1.py`). Isso é mais
# robusto do que apontar diretamente para a pasta do pacote.
        ...
        while True:
            try:
                ...
                if msg_type == 'online_clients':
                    ...
                    # data_content pode ser hex string (quando roteado pelo servidor) ou bytes
                    ...
                    # Resposta do servidor para uma requisição de chave pública
                    ...
                    try:
                        # data_content pode ser hex string quando roteado pelo servidor
                        if isinstance(data_content, str):
                            encrypted_msg = bytes.fromhex(data_content)
                        else:
                            encrypted_msg = data_content

                        decrypted_message = self.symmetric_crypto.decrypt(encrypted_msg)
